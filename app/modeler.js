...
$(function () {
  ...
  */
  ...
  // cawemo color picker
  // <div class="djs-palette open" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"><div class="djs-palette-entries"><div class="group" data-group="tools"><div class="entry bpmn-icon-hand-tool" draggable="true" data-action="hand-tool" title="Activate the hand tool"></div><div class="entry bpmn-icon-lasso-tool" draggable="true" data-action="lasso-tool" title="Activate the lasso tool"></div><div class="entry bpmn-icon-space-tool" draggable="true" data-action="space-tool" title="Activate the create/remove space tool"></div><div class="entry bpmn-icon-connection-multi" draggable="true" data-action="global-connect-tool" title="Activate the global connect tool"></div><hr class="separator"></div><div class="group" data-group="event"><div class="entry bpmn-icon-start-event-none" draggable="true" data-action="create.start-event" title="Create StartEvent"></div><div class="entry bpmn-icon-intermediate-event-none" draggable="true" data-action="create.intermediate-event" title="Create Intermediate/Boundary Event"></div><div class="entry bpmn-icon-end-event-none" draggable="true" data-action="create.end-event" title="Create EndEvent"></div></div><div class="group" data-group="gateway"><div class="entry bpmn-icon-gateway-none" draggable="true" data-action="create.exclusive-gateway" title="Create Gateway"></div></div><div class="group" data-group="activity"><div class="entry bpmn-icon-task" draggable="true" data-action="create.task" title="Create Task"></div><div class="entry bpmn-icon-subprocess-expanded" draggable="true" data-action="create.subprocess-expanded" title="Create expanded SubProcess"></div></div><div class="group" data-group="data-object"><div class="entry bpmn-icon-data-object" draggable="true" data-action="create.data-object" title="Create DataObjectReference"></div></div><div class="group" data-group="data-store"><div class="entry bpmn-icon-data-store" draggable="true" data-action="create.data-store" title="Create DataStoreReference"></div></div><div class="group" data-group="collaboration"><div class="entry bpmn-icon-participant" draggable="true" data-action="create.participant-expanded" title="Create Pool/Participant"></div></div><div class="group" data-group="artifact"><div class="entry bpmn-icon-group" draggable="true" data-action="create.group" title="Create Group"></div></div></div><div class="djs-palette-toggle"></div></div>
  // <div class="djs-popup bpmn-colorize" style="position: absolute; left: 379px; top: 172px; visibility: visible; transform-origin: left top; transform: scale(1); z-index: 1000;"><div class="djs-popup-header"><div class="entry bjs-color-menu-entry" data-id="colorize-none" title="None"></div><div class="entry bjs-color-menu-entry" data-id="colorize-blue" title="Blue"></div><div class="entry bjs-color-menu-entry" data-id="colorize-orange" title="Orange"></div><div class="entry bjs-color-menu-entry" data-id="colorize-green" title="Green"></div><div class="entry bjs-color-menu-entry" data-id="colorize-red" title="Red"></div><div class="entry bjs-color-menu-entry" data-id="colorize-purple" title="Purple"></div></div></div>   
  //color picker..
