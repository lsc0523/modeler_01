...
ToggleMode.prototype._init = function() {
  this._container = domify(`
    ...
    Process Start <span class="toggle"><i class="fa fa-toggle-off"></i></span>
    </div>
  `);
...
ToggleMode.prototype.toggleMode = function(active = !this._active) {
  ...
  if (active) {
    this._container.innerHTML = 'Process Start <span class="toggle"><i class="fa fa-toggle-on"></i></span>';

    domClasses(this._canvasParent).add('simulation');
    domClasses(this._palette).add('hidden');
  } else {
    this._container.innerHTML = 'Process Start <span class="toggle"><i class="fa fa-toggle-off"></i></span>';
